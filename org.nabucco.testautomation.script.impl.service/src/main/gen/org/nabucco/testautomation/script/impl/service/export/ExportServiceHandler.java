...
/**
 * ExportServiceHandler<p/>Export Service for Script<p/>
 *
 * @version 1.0
...
public abstract class ExportServiceHandler extends ServiceHandlerSupport implements ServiceHandler {
    ...
    private static final String ID = "org.nabucco.testautomation.script.impl.service.export.ExportServiceHandler";
