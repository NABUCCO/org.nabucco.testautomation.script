...
/**
 * ProduceMetadataCloneServiceHandler<p/>Folder produce service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-08-20
 */
public abstract class ProduceMetadataCloneServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<MetadataMsg> invoke(ServiceRequest<MetadataMsg> rq) throws ProduceException {
