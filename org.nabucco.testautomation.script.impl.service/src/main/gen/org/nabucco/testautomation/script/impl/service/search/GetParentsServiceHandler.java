...
/**
 * GetParentsServiceHandler<p/>Metadata search service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-20
 */
public abstract class GetParentsServiceHandler extends ServiceHandlerSupport implements
        ServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.testautomation.script.impl.service.search.GetParentsServiceHandler";

    /** Constructs a new GetParentsServiceHandler instance. */
    public GetParentsServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<MetadataMsg> invoke(ServiceRequest<MetadataMsg> rq)
        ...
        try {
            ...
            msg = this.getParents(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws SearchException
     */
    protected abstract MetadataMsg getParents(MetadataMsg msg) throws SearchException;
