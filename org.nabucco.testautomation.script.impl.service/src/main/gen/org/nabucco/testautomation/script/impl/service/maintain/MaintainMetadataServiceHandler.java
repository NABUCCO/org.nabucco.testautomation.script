...
/**
 * MaintainMetadataServiceHandler<p/>Folder maintenance service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-08-09
 */
public abstract class MaintainMetadataServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<MetadataMsg> invoke(ServiceRequest<MetadataMsg> rq) throws MaintainException {
