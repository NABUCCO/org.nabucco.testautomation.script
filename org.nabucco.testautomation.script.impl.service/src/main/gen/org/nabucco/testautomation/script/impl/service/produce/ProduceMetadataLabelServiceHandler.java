...
/**
 * ProduceMetadataLabelServiceHandler<p/>Folder produce service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-08-20
 */
public abstract class ProduceMetadataLabelServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<MetadataLabelMsg> invoke(ServiceRequest<EmptyServiceMessage> rq) throws ProduceException {
     ...
     * @throws ProduceException
     */
    protected abstract MetadataLabelMsg produceMetadataLabel(EmptyServiceMessage msg) throws ProduceException;
