...
/**
 * SearchSubEngineCodeServiceHandler<p/>Script search service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-08-13
 */
public abstract class SearchSubEngineCodeServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     * @throws SearchException
     */
    protected abstract SubEngineCodeListMsg searchSubEngineCode(SubEngineCodeSearchMsg msg) throws SearchException;
