...
/**
 * ExportScriptImpl<p/>Export Service for Script<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2011-02-04
 */
public class ExportScriptImpl extends ServiceSupport implements ExportScript {

    private static final long serialVersionUID = 1L;

    private static final String ID = "ExportScript";

    private EntityManager entityManager;

    private ExportServiceHandler exportServiceHandler;

    /** Constructs a new ExportScriptImpl instance. */
    public ExportScriptImpl() {
        super();
    }
