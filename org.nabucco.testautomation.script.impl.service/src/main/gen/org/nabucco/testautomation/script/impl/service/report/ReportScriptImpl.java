...
/**
 * ReportScriptImpl<p/>Script reporting service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2011-12-22
 */
public class ReportScriptImpl extends ServiceSupport implements ReportScript {

    private static final long serialVersionUID = 1L;

    private static final String ID = "ReportScript";
    ...
    /** Constructs a new ReportScriptImpl instance. */
    public ReportScriptImpl() {
        super();
    }
