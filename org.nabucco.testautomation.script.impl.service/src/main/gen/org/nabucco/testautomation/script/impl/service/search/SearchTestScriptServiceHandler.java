...
/**
 * SearchTestScriptServiceHandler<p/>Script search service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-08-13
 */
public abstract class SearchTestScriptServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<TestScriptListMsg> invoke(ServiceRequest<TestScriptSearchMsg> rq) throws SearchException {
     ...
     * @throws SearchException
     */
    protected abstract TestScriptListMsg searchTestScript(TestScriptSearchMsg msg) throws SearchException;
