...
public class ProduceTestScriptElementCloneServiceHandlerImpl extends ProduceTestScriptElementCloneServiceHandler {
    ...
    @Override
    protected ProduceTestScriptElementMsg produceTestScriptElementClone(ProduceTestScriptElementMsg msg)
        ...
        try {
            ...
            TestScriptElementCloneVisitor visitor = new TestScriptElementCloneVisitor(subEngineCodeMap, metadataMap,
                    scriptMap);
        ...
        if (clone.getType() == TestScriptElementType.SCRIPT) {
            ...
            if (msg.getImportElement() != null
                    && msg.getImportElement().getValue() != null && msg.getImportElement().getValue().booleanValue()) {
                // Import of TestScript -> Add TestScript to root folder of current owner
                try {
                    Folder root = FolderSupport.getInstance().getRootFolder(super.getContext());
