...
public class MetadataMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(METADATA, PropertyDescriptorSupport.createDatatype(METADATA, Metadata.class, 0,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(MetadataMsg.getPropertyDescriptor(METADATA), this.getMetadata()));
        return properties;
    }
