...
public class FolderListMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(FOLDERLIST, PropertyDescriptorSupport.createCollection(FOLDERLIST, Folder.class, 0,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(FolderListMsg.getPropertyDescriptor(FOLDERLIST), this.folderList));
        return properties;
    }
