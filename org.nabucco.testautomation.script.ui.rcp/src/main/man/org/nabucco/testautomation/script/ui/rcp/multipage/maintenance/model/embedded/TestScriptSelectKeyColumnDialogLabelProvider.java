...
/**
 * TestScriptSelectKeyColumnDialogLabelProvider
 * 
 * @author Markus Jorroch, PRODYNA AG
 */
public class TestScriptSelectKeyColumnDialogLabelProvider extends
    ...
    public String getText(final Object obj) {
        ...
        if (obj instanceof TestScriptElementContainer) {
            ...
            if (datatypeState != DatatypeState.INITIALIZED) {
                String name = testScript.getIdentificationKey().getValue();
                result = name;
            } else {
                result = "";
            }
