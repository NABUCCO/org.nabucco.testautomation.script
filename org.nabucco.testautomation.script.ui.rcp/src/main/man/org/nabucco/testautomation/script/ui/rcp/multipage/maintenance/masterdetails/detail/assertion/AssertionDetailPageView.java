...
/**
 * AssertionDetailPageView
 * 
 * @author Steffen Schmidt, PRODYNA AG
 */
public class AssertionDetailPageView extends PropertyDetailPageView<ScriptMaintenanceMultiplePageEditViewModel> {

    /**
     * Creates a new {@link AssertionDetailPageView} instance.
     * 
     * @param block
     ...
     */
    public AssertionDetailPageView(MasterDetailBlock<ScriptMaintenanceMultiplePageEditViewModel> block, IManagedForm managedForm,
    ...
    protected GeneralDetailPageViewLayouter getLayouter(String detailTitle) {
        return new AssertionDetailPageViewLayouter(detailTitle);
    }
