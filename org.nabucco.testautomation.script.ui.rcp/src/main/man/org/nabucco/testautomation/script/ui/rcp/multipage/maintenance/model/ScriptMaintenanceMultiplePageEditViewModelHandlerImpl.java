...
import org.nabucco.testautomation.script.ui.rcp.command.script.FindAndReplaceCommand;
...
/**
 * ScriptMaintenanceMultiplePageEditViewModelHandlerImpl
 * 
 * @author Markus Jorroch, PRODYNA AG
 */
public class ScriptMaintenanceMultiplePageEditViewModelHandlerImpl implements
        ScriptMaintenanceMultiplePageEditViewModelHandler {

    public static final String ID = "org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.model.ScriptMaintenanceMultiplePageEditViewModelHandlerImpl";
    ...
    public MasterDetailTreeNode addChild(final MasterDetailTreeNode parent, final Datatype newChild) {
        ...
        if (newChild instanceof TestScript) { // Root case
            ...
            if (parentDatatype instanceof TestScriptComposite) {
                ...
                testScriptElementContainer.setOrderIndex(parentTestScriptComposite.getTestScriptElementList().size());
                result = addChildToTree(parent, testScriptElementContainer.getElement());
                parentTestScriptComposite.getTestScriptElementList().add(testScriptElementContainer);
            }
        ...
        if (result == null) {
            Activator.getDefault().logError(
                    new NabuccoLogMessage(ScriptMaintenanceMultiplePageEditViewModelHandlerImpl.class,
    ...
    public void remove(ISelection child) {
        ...
        if (datatypeToRemove instanceof TestScriptElement) {
            ...
            TestScriptElementContainer containerToBeDeleted = testScriptElementContainerList.get(indexOfNodeToDelete);
    ...
    public AddDialogLabelProvider getAddDialogLabelProvider() {
        return new ScriptMaintenanceMasterDetailAddDialogLabelProvider();
    }
    ...
    private NabuccoTableColumnInfo[] createColumnInfo() {
        NabuccoTableColumnInfo[] result = new NabuccoTableColumnInfo[] { new NabuccoTableColumnInfo(
                ...
                "org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.model.tooltip", 200,
                new ScriptMaintenanceMasterDetailAddDialogLabelProvider()) };
        return result;
    }
    ...
    public boolean up(ISelection selection) {
        ...
        if (firstElement instanceof MasterDetailTreeNode) {
            ...
            if (datatypeToMove instanceof TestScriptElement && parentDatatype instanceof TestScriptComposite) {
                TestScriptComposite parentTestScriptComposite = (TestScriptComposite) parentDatatype;
                // Check for PropertyList and increase index
                if (parentTestScriptComposite.getPropertyList() != null) {
                    indexOfNodeToMove--;
                ...
                if (indexOfNodeToMove > 0) {
                    switchContainerOrder(elementContainerToMove, parentTestScriptComposite.getTestScriptElementList()
                            .get(currentOrder - 1));
        ...
        if (firstElement instanceof MasterDetailTreeNode) {
            ...
            if (datatypeToMove instanceof TestScriptElement && parentDatatype instanceof TestScriptComposite) {
                ...
                TestScriptElementContainer elementContainerToMove = parentTestScriptComposite
                        .getTestScriptElementList().get(indexOfNodeToMove);
                Integer currentOrder = elementContainerToMove.getOrderIndex().getValue();
                switchContainerOrder(elementContainerToMove,
                        parentTestScriptComposite.getTestScriptElementList().get(currentOrder + 1));
                elementSorter.sort(parentTestScriptComposite);
                DataModelManager.normalizeOrderIndicies(parentTestScriptComposite, false);
                return true;
            } else if (datatypeToMove instanceof Property && parentDatatype instanceof PropertyList) {
    ...
    /* (non-Javadoc)
     * @see org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.model.ScriptMaintenanceMultiplePageEditViewModelHandler#replace(org.eclipse.jface.viewers.ISelection)
     */
    @Override
    ...
    private void switchContainerOrder(TestScriptElementContainer elementContainerToMove,
    ...
    private void switchContainerOrder(PropertyContainer propertyContainer1, PropertyContainer propertyContainer2) {
