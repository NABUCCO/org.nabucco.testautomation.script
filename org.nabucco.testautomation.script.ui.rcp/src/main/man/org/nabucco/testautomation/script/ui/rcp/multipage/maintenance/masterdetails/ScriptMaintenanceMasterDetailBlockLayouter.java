 ...
 */
public class ScriptMaintenanceMasterDetailBlockLayouter extends MasterDetailBlockLayouter<ScriptMaintenanceMultiplePageEditViewModel> {

    /**
     * Default constructor.
     */
    public ScriptMaintenanceMasterDetailBlockLayouter() {
        super(
                "org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.title",
                "org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.description");
    }
    ...
    public I18NLabelProviderContributor getMasterDetailLabelProvider() {
        return ScriptMaintenanceMasterDetailLabelProvider.getInstance();
    }
