...
public class FindAndReplaceWizardPage extends WizardPage {
    ...
    private static final String ID = "org.nabucco.testautomation.script.ui.rcp.multipage.script.maintenance.wizard.FindAndReplaceWizardPage";
    ...
    private Button messageCb;

    private Button referenceCb;
    ...
    public void createControl(Composite parent) {
        ...
        messageCb = new Button(optionsPlate, SWT.CHECK);
        messageCb.setSelection(true);
        Label descriptionLabel = new Label(optionsPlate, SWT.NULL);
        descriptionLabel.setText((I18N.i18n(ID + ".options.message")));

        referenceCb = new Button(optionsPlate, SWT.CHECK);
        referenceCb.setSelection(true);
        Label documentationLabel = new Label(optionsPlate, SWT.NULL);
        documentationLabel.setText((I18N.i18n(ID + ".options.reference")));
        ...
        messageCb.addSelectionListener(checkBoxSelectionListener);
        referenceCb.addSelectionListener(checkBoxSelectionListener);
    ...
    public boolean getFindInMessages() {
        return this.messageCb.getSelection();
    }

    public boolean getFindInReferences() {
        return this.referenceCb.getSelection();
    }
    ...
    private boolean validatePage() {
        return this.findTf.getText().length() > 0
                ...
                && (this.nameCb.getSelection()
                        || this.messageCb.getSelection() || this.referenceCb.getSelection()
