...
public class FolderMaintenanceMasterDetailAddDialogLabelProvider extends AddDialogLabelProvider {

    @Override
    public String getText(Object obj) {
        String result = null;
        if (obj instanceof Folder) {
        	Folder element = (Folder) obj;
        ...
        }  else if (obj instanceof TestScript) {
