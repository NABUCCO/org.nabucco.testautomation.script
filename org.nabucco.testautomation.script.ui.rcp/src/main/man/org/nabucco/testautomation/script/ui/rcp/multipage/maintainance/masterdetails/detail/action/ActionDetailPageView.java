 ...
 */
public class ActionDetailPageView extends TestautomationDetailPageView<ScriptMaintainanceMultiplePageEditViewModel> {

    /**
     * Creates a new {@link ActionDetailPageView} instance.
     * 
     * @param block
     ...
     */
    public ActionDetailPageView(MasterDetailBlock<ScriptMaintainanceMultiplePageEditViewModel> block, IManagedForm managedForm,
    ...
    protected GeneralDetailPageViewLayouter getLayouter(String detailTitle) {
        return new ActionDetailPageViewLayouter(detailTitle);
    }
