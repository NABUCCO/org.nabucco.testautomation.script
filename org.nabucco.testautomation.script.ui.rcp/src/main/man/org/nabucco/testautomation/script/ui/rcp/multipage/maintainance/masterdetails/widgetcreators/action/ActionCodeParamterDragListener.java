...
/**
 * ActionCodeParamterDragListener
 * 
 * @author Markus Jorroch, PRODYNA AG
 */
public class ActionCodeParamterDragListener implements DragSourceListener {

    private TableViewer viewer;

    public ActionCodeParamterDragListener(TableViewer viewer) {
        this.viewer = viewer;
    }
