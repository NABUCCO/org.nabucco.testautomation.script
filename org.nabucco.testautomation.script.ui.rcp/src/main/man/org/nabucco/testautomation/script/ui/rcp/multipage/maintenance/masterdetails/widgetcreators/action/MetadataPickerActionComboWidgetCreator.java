...
import org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.widgetcreators.action.action.SubEngineActionCodeComboBoxHandler;
import org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.widgetcreators.action.action.SubEngineActionCodeLabelProvider;
import org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.widgetcreators.action.metadata.MetadataPickerDialogContentProvider;
import org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.widgetcreators.action.metadata.MetadataPickerDialogLabelProvider;
import org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.widgetcreators.action.metadata.MetadataPickerDialogListener;
import org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.widgetcreators.action.metadata.MetadataTreePickerDialog;
 ...
 */
public class MetadataPickerActionComboWidgetCreator extends AbstractBaseTypeWidgetCreator<Metadata> {

    private static final String ID = "org.nabucco.testautomation.script.ui.rcp.multipage.script.maintenance.masterdetails.widgetcreators.metadata.MetadataPicker";
     ...
     *            the form toolkit
     */
    public MetadataPickerActionComboWidgetCreator(Composite parent, BaseTypeWidgetFactory widgetFactory, GridData data,
            NabuccoFormToolkit nft, ViewModel externalViewModel, String masterBlockId, Metadata metadata,
            Action action, boolean readOnly) {
        super(nft);
        this.parent = parent;
    ...
    private Control layoutActionCombo(MetadataPickerActionComboMiniModel model) {
        ...
        // Layout ActionCombo
        ElementPickerCombo combo = super.getFormToolkit().createElementPickerCombo(parent, parameter, readOnly, false);
    ...
    private Control layoutPicker(MetadataPickerActionComboMiniModel model) {
        ...
        ElementPickerComposite<TreePickerDialog> picker = this.createPicker(parent, model);
    ...
    private ElementPickerComposite<TreePickerDialog> createPicker(Composite parent,
            MetadataPickerActionComboMiniModel model) {
        ...
        MetadataTreePickerDialog dialog = new MetadataTreePickerDialog(parent.getShell(), parameter,
                this.action.getMetadata());

        dialog.addSelectionListener(MetadataPickerDialogListener.ID, new MetadataPickerDialogListener(model));
    ...
    private TableViewer layoutPropertiesControl() {
        Label label = widgetFactory.createLabel(parent, masterBlockId
                + "." + MetadataPickerActionComboMiniModel.PROPERTY_ACTION_DESCRIPTION);
        label.setToolTipText(label.getText());
        label.setLayoutData(data);
    ...
    @Override
    protected Control createWidget(Composite parent, Metadata specialized, Method method, Object object,
