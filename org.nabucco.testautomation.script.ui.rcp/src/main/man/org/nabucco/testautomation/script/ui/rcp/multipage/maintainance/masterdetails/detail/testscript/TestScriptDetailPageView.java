 ...
 */
public class TestScriptDetailPageView extends TestautomationDetailPageView<ScriptMaintainanceMultiplePageEditViewModel> {

    /**
     * Creates a new {@link TestScriptDetailPageView} instance.
     * 
     * @param block
     ...
     */
    public TestScriptDetailPageView(MasterDetailBlock<ScriptMaintainanceMultiplePageEditViewModel> block, IManagedForm managedForm,
    ...
    protected GeneralDetailPageViewLayouter getLayouter(String detailTitle) {
        return new TestScriptDetailPageViewLayouter(detailTitle);
    }
