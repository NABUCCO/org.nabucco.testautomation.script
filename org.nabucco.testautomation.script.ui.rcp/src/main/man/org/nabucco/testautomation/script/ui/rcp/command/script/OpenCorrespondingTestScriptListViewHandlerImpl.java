...
import org.nabucco.testautomation.script.ui.rcp.command.script.OpenCorrespondingTestScriptListViewHandler;
...
/**
 * OpenCorrespondingTestScriptListViewHandlerImpl
 * 
 * @author Markus Jorroch, PRODYNA AG
 */
public class OpenCorrespondingTestScriptListViewHandlerImpl
        extends
        AbstractNabuccoOpenCorrespondingListViewHandlerImpl<TestScriptListViewBrowserElement, TestScriptListViewModel>
        implements OpenCorrespondingTestScriptListViewHandler {

    /**
     * {@inheritDoc}
     */
    @Override
    public void openCorrespondingTestScriptListView() {
        run();
    }
