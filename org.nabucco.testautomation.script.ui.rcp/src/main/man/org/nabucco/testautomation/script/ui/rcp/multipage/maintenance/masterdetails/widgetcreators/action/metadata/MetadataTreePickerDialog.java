...
public class MetadataTreePickerDialog extends OwnerSelectionTreePickerDialog {
    ...
    public static final String ID = "org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.widgetcreators.action.metadata.MetadataTreePickerDialog";
    ...
    public MetadataTreePickerDialog(Shell parentShell, TreePickerDialogParameter parameter, Metadata selectedMetadata) {
    ...
    protected void createViewer(Composite parent) {
        ...
        if (this.selectedMetadata != null) {
            ...
            if (this.selectedMetadata.getParent() == null) {
                try {
                    ResolveScriptDelegate delegate = ScriptComponentServiceDelegateFactory.getInstance()
                            .getResolveScript();
                    MetadataMsg rq = new MetadataMsg();
                    rq.setMetadata(selectedMetadata);
                    this.selectedMetadata = delegate.resolveParents(rq).getMetadata();
