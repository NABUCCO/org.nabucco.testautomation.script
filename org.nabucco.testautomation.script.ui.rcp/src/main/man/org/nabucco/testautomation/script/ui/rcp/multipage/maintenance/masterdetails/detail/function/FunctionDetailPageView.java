 ...
 */
package org.nabucco.testautomation.script.ui.rcp.multipage.maintenance.masterdetails.detail.function;
...
/**
 * FunctionDetailPageView
 * 
 * @author Steffen Schmidt, PRODYNA AG
 */
public class FunctionDetailPageView extends PropertyDetailPageView<ScriptMaintenanceMultiplePageEditViewModel> {

    /**
     * Creates a new {@link FunctionDetailPageView} instance.
     * 
     * @param block
     ...
     */
    public FunctionDetailPageView(MasterDetailBlock<ScriptMaintenanceMultiplePageEditViewModel> block, IManagedForm managedForm,
    ...
    protected GeneralDetailPageViewLayouter getLayouter(String detailTitle) {
        return new FunctionDetailPageViewLayouter(detailTitle);
    }
