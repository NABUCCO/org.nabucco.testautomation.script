 ...
 */
public class FileContentDialog extends TitleAreaDialog {

    private static final String ID = "org.nabucco.testautomation.property.ui.rcp.multipage.detail.textarea.TextAreaDialog";
    ...
    /**
     * Creates a new {@link FileContentDialog} instance.
     */
    public FileContentDialog(Shell shell, NameContentCombinationMiniModel model, boolean readOnly) {
        super(shell);
    ...
    public void create() {
        ...
        setDefaultImage(ImageProvider.createImage(PropertyImageRegistry.ICON_DETAILS_DIALOG.getId()));
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        this.textarea.setText(model.getContent());
        return area;
    }
