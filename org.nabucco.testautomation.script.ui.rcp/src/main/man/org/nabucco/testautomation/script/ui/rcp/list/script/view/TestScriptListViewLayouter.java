...
public class TestScriptListViewLayouter extends NabuccoAbstractListLayouter<TestScriptListViewModel> {
    ...
    public NabuccoTableViewer layout(final Composite parent, final NabuccoMessageManager messageManager,
            final TestScriptListViewModel model, final Layoutable<TestScriptListViewModel> view) {
        ...
        NabuccoTableParameter parameter = new NabuccoTableParameter(new NabuccoDefaultTableSorter<TestScript>(
                createComparators()), new TestScriptListViewTableFilter(),
                new NabuccoDefaultListContentProvider(model), createTableColumnInfo(),
                getDoubleClickCommand(view.getManagedFormViewPart()));
    ...
    private NabuccoTableColumnInfo[] createTableColumnInfo() {
        ...
        NabuccoTableColumnInfo col3 = new NabuccoTableColumnInfo(DESCRIPTION_COLUMN_KEY, DESCRIPTION_COLUMN_KEY, 400,
                SWT.LEFT, SWT.LEFT, new TestScriptListViewTestScriptDescriptionLabelProvider());
