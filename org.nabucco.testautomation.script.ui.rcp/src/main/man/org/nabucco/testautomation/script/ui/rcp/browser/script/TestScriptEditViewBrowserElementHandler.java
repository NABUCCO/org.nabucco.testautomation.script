...
public interface TestScriptEditViewBrowserElementHandler extends CommandHandler {
     ...
     */
    ScriptMaintenanceMultiplePageEditViewModel loadFull(
            final ScriptMaintenanceMultiplePageEditViewModel testScript);
     ...
     *            the TestScriptEditViewModel.
     */
    void createChildren(final ScriptMaintenanceMultiplePageEditViewModel viewModel,
