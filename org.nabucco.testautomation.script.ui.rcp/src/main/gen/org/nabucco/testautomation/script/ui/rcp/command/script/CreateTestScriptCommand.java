...
public class CreateTestScriptCommand implements NabuccoCommand {
    ...
    private CreateTestScriptCommandHandler createTestScriptCommandHandler = NabuccoInjector.getInstance(
            CreateTestScriptCommand.class).inject(CreateTestScriptCommandHandler.class);
