...
public class MaintainFolderStructureCommand implements NabuccoCommand {
    ...
    private MaintainFolderStructureHandler maintainFolderStructureHandler = NabuccoInjector.getInstance(
            MaintainFolderStructureCommand.class).inject(MaintainFolderStructureHandler.class);
