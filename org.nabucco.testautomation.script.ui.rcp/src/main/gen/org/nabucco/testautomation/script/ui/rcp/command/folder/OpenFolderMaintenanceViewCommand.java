...
public class OpenFolderMaintenanceViewCommand implements NabuccoCommand {
    ...
    private OpenFolderMaintenanceViewHandler openFolderMaintenanceViewHandler = NabuccoInjector.getInstance(
            OpenFolderMaintenanceViewCommand.class).inject(OpenFolderMaintenanceViewHandler.class);
