 ...
 */
package org.nabucco.testautomation.script.ui.web.communication.report;
...
public class ReportScriptDelegate extends ServiceDelegateSupport {
    ...
    public DashboardStatisticMsg getDashboardStatistic(EmptyServiceMessage message, NabuccoSession session,
        ...
        throw new SearchException("Cannot execute service operation: ReportScript.getDashboardStatistic");
    }
}
