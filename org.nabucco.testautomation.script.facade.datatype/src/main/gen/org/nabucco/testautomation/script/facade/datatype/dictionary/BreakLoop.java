...
public class BreakLoop extends TestScriptComposite implements Datatype {
    ...
    private static final TestScriptElementType TYPE_DEFAULT = TestScriptElementType.BREAK_LOOP;
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(BreakLoop.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(BreakLoop.class).getAllProperties();
    }
}
