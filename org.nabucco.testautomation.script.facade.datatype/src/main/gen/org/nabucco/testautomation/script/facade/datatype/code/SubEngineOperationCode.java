...
public class SubEngineOperationCode extends NabuccoDatatype implements Datatype {
    ...
    private static final String[] PROPERTY_NAMES = { "name", "code", "actionList", "description",
            "parameterList" };
    ...
    private List<SubEngineActionCode> actionList;
    ...
    protected void cloneObject(SubEngineOperationCode clone) {
        ...
        if ((this.actionList instanceof NabuccoList<?>)) {
            clone.actionList = ((NabuccoList<SubEngineActionCode>) this.actionList)
                    .cloneCollection();
        }
    ...
    List<SubEngineActionCode> getActionListJPA() {
        if ((this.actionList == null)) {
            this.actionList = new NabuccoList<SubEngineActionCode>(NabuccoCollectionState.LAZY);
        }
        return ((NabuccoList<SubEngineActionCode>) this.actionList).getDelegate();
    }
    ...
    void setActionListJPA(List<SubEngineActionCode> actionList) {
        ...
        ((NabuccoList<SubEngineActionCode>) this.actionList).setDelegate(actionList);
    }
    ...
    public List<NabuccoProperty<?>> getProperties() {
        ...
        properties.add(new ListProperty<SubEngineActionCode>(PROPERTY_NAMES[2],
                SubEngineActionCode.class, PROPERTY_CONSTRAINTS[2], this.actionList));
        ...
        properties.add(new ListProperty<CodeParameter>(PROPERTY_NAMES[4], CodeParameter.class,
                PROPERTY_CONSTRAINTS[4], this.parameterList));
        return properties;
    }
    ...
    public String toString() {
        ...
        appendable.append("<SubEngineOperationCode>\n");
     ...
     * @return the List<SubEngineActionCode>.
     */
    public List<SubEngineActionCode> getActionList() {
        if ((this.actionList == null)) {
            this.actionList = new NabuccoList<SubEngineActionCode>(
